import { Github, Twitter, Linkedin, Code, Paintbrush, Server, BarChart, Instagram } from 'lucide-react';
...
export const defaultSocialLinks: SocialLink[] = [
  ...
  { id: 'instagram', name: 'Instagram', url: 'https://instagram.com', icon: Instagram, placeholder: 'https://instagram.com/your-username' },
];
